...
**Binding: there is never a second locator engine.** `RecordedTarget` stores the verified _chain_,
...
**Framework-Aware Test Generation** — _not_ "build an automation framework".
...
**"Learn My Framework"** analyses locally and reports what it found — e.g. _12 Page Objects,
8 fixtures, 34 tests_ — before saving a profile.
...
The intersection — **opinionated _and_ provably Playwright-faithful** — is currently empty.
